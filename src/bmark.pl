...
sub main {
    ...
    %numeric_processed_data = map { @$_ }
        @{ $reader->getline_all ($numeric_processed_data_csv) };
    ...
    diag
        "Regular Hash:\t\t\t", (timeit $timed_iteration, \&regular_hash)->real, "s\n",
        "Keys Assignment:\t\t", (timeit $timed_iteration, \&keys_assignment)->real, "s\n",
        "Numeric Regular Hash:\t\t", (timeit $timed_iteration, \&numeric_regular_hash)->real, "s\n",
        "Numeric Keys Assignment:\t", (timeit $timed_iteration, \&numeric_keys_assignment)->real, "s\n",
        "Numeric No Hash:\t\t", (timeit $timed_iteration, \&numeric_no_hash)->real, "s\n",
    ;
    ...
    is_deeply \%keys_assignment_ret, \%processed_data, 'Keys Assignment Hash is correct';
    is_deeply \%numeric_regular_hash_ret, \%numeric_processed_data, 'Numeric Regular Hash is correct';
    is_deeply \%numeric_keys_assignment_ret, \%numeric_processed_data, 'Numeric Keys Assignment Hash is correct';
    is_deeply \%numeric_no_hash_ret, \%numeric_processed_data, 'Numeric No Hash is correct';
}
